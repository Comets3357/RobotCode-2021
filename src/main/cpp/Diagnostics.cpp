...
void Diagnostics::LogPeriodic(RobotData &robotData, DiagnosticsData &diagnosticsData)
{
    ...
    frc::SmartDashboard::PutNumber("location", location);
    ...
    // encoders
    frc::SmartDashboard::PutNumber("dbRMPosition", diagnosticsData.mControlPositions.at(3));
    frc::SmartDashboard::PutNumber("dbLMPosition", diagnosticsData.mControlPositions.at(1));

    frc::SmartDashboard::PutNumber("dbRMVelocity", diagnosticsData.mControlVelocities.at(3));
    frc::SmartDashboard::PutNumber("dbLMVelocity", diagnosticsData.mControlVelocities.at(1));

    // intake
    frc::SmartDashboard::PutBoolean("intakeSolenoidOne", diagnosticsData.solenoidOneValue);
}
...
{
    fmsAttatched = frc::DriverStation::GetInstance().IsFMSAttached();
