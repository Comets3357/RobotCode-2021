...
void Controller::updateData(RobotData &robotData){
    ...
    robotData.sXBtn = getButton(1, 1); //controls omni wheel indexer in auto
    robotData.sYBtn = getButton(1, 5); // controls indexer in auto
    robotData.sLBumper = getButton(1, 3); // controls  intake in auto
    robotData.sRBumper = getButton (1, 2); // controls intake in auto
    robotData.sABtn = getButton(1, 4); // controls intake in auto
    robotData.sRTrigger = getAxis(1, 2); //manual
    robotData.sLTrigger = getAxis(1, 3); // manual
    robotData.sLBumper = getButton(1, 6); // manual
